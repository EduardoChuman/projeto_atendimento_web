                          ...
                          <tr>
                            <td style='padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;'><!-- ======= start header ======= -->
                              ...
                              <table class='one-column' border='0' cellpadding='0' cellspacing='0' width='100%' style='border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:5px solid #e8e7e5' bgcolor='#FFFFFF'>
                                <tr>
                                 <td background='http://www.geopc.mz.caixa/esteiracomex/data/images/img04.jpg' bgcolor='#ffffff' width='800' height='200' valign='top' align='left' style='padding:50px 40px 60px 40px'>
                                    <div>
                                                      ...
                                                      <table border='0' cellpadding='0' cellspacing='0' style='Margin:0 auto;'>
                                                        <tr>
                                                          <td width='250' height='60' align='center' bgcolor='#1f3ca6' style='-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;'>
                                                            <a href='http://www.ceopc.hom.sp.caixa/atendimento_web/index_responde_pesquisa.php?idAtendimento=" . $idRegistroAtendimento . "&matriculaAtendido=" . $matriculaAtendido . "' style='width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff' class='button_link'>Responda aqui<img src='http://www.ceopc.hom.sp.caixa/atendimento_web/images/arrow.png' width='32' height='17' style='padding-top:5px' alt='' border='0'/></a>
                                                          </td>
                                                        </tr>
                                                      </table>
                                                    </td>
                              ...
                              <table class='one-column' border='0' cellpadding='0' cellspacing='0' width='100%' style='border-spacing:0;max-width: 800px; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-top:1px solid #e8e7e5' bgcolor='#FFFFFF'>
                                <tr>
                                  <td align='center'>
                                    <img src='http://www.geopc.mz.caixa/esteiracomex/data/images/img01.jpg' width='100%' style='max-width:800px;'  alt=''/>
                                  </td>
                                </tr>
                              </table>
