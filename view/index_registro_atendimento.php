        ...
        <fieldset>
            ...
            <label>SELECIONE O TIPO DE ATENDIMENTO:
                <select id="selectbox" name="tipoGrupoAtendimento" onchange="javascript:location.href = this.value;">
                    ...
                    <option value="criarFormRegistroAtendimento.php?tipoGrupoAtendimento=ROTINA">ROTINA</option>
                    <option value="criarFormRegistroAtendimento.php?tipoGrupoAtendimento=CONSULTORIA">CONSULTORIA</option>
                </select>
            </label>
