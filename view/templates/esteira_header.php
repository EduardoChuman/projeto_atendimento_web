			...
			<header class="main-header">
				...
				<a href="#" class="logo">
					<!-- Mini logotipo CAIXA -->
					<span class="logo-mini"><img class="logoMinPersonalizado"src="dist/img/corp_min.jpg"></span>
					<!-- Logotipo CAIXA -->
					<span class="logo-lg"><img class="logoPersonalizado"src="dist/img/caixa_corp_.jpg"></span>
				</a>
