		...
		try
		{
			...
			(
				...
				SELECT 
					...
					,'mediaCordialidade' = AVG(CONVERT(FLOAT,[NOTA_CORDIALIDADE]))
					,'mediaDominio' = AVG(CONVERT(FLOAT,[NOTA_DOMINIO]))
					,'mediaTempestividade' = AVG(CONVERT(FLOAT,[NOTA_TEMPESTIVIDADE]))
				FROM 
