...
// mexi em 01/03 @MES_ANTERIOR = DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE())) estava com 2 no parametro e página não estava carregando;
	...
	public function contagemCanalAtendimento()
	{
		...
		try
		{
			...
			(
				...
				SELECT
					'lote' = CASE @DOIS_MESES_ANTES_INT 
								WHEN 10 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -4, GETDATE()))), 2)))
								WHEN 11 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))), 2)))
								WHEN 12 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -2, GETDATE()))), 2)))
								ELSE CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, 0, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, 0, GETDATE()))), 2))) 
							END
				...
				SELECT
					'lote' = CASE @DOIS_MESES_ANTES_INT 
								...
								WHEN 11 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))), 2)))
								WHEN 12 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -2, GETDATE()))), 2)))
								ELSE CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, 0, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -1, GETDATE()))), 2))) 
							END
				...
				SELECT
					'lote' = CASE @DOIS_MESES_ANTES_INT 
								...
								WHEN 11 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))), 2)))
								WHEN 12 THEN CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -2, GETDATE()))), 2)))
								ELSE CONVERT(VARCHAR, CONCAT(DATEPART(YEAR, DATEADD(YEAR, 0, GETDATE())), '/', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -2, GETDATE()))), 2))) 
							END
		...
		try
		{
			...
			(
				...
				SELECT 
					...
					,'mediaAtendimentoMiddle' = CAST(((CAST(AVG(CONVERT(FLOAT,[NOTA_CORDIALIDADE])) AS DECIMAL (10,2)) + CAST(AVG(CONVERT(FLOAT,[NOTA_DOMINIO])) AS DECIMAL (10,2)) + CAST(AVG(CONVERT(FLOAT,[NOTA_TEMPESTIVIDADE])) AS DECIMAL (10,2))) / 3) AS DECIMAL (10,2))
				FROM 
	...
	public function feedbackAtendidosGeral()
	{
		...
		try
		{
			...
			(
				...
				SET @MES_ANTERIOR = DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))
				
				SET @PERIODO_INICIAL = CASE @MES_ANTERIOR 
											WHEN 10 THEN CONVERT(DATETIME, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '-', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))), 2), '-', '01', ' ', '00:00:00'), 120)
											WHEN 11 THEN CONVERT(DATETIME, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '-', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -2, GETDATE()))), 2), '-', '01', ' ', '00:00:00'), 120)
											WHEN 12 THEN CONVERT(DATETIME, CONCAT(DATEPART(YEAR, DATEADD(YEAR, -1, GETDATE())), '-', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -1, GETDATE()))), 2), '-', '01', ' ', '00:00:00'), 120)
											ELSE CONVERT(DATETIME, CONCAT(DATEPART(YEAR, DATEADD(YEAR, 0, GETDATE())), '-', RIGHT('0' + RTRIM(DATEPART(MONTH, DATEADD(MONTH, -3, GETDATE()))), 2), '-', '01', ' ', '00:00:00'), 120)
										END
