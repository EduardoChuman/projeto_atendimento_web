CREATE PROCEDURE sp_relatorio_atendimento_web_middle
AS
...
CREATE TABLE [dbo].[tbl_ANT_RELATORIO_TEMP_PRODUCAO]
(
[MES] INT NULL,
[RS] INT NULL,
[SC] INT NULL,
...
BEGIN
	...
	BEGIN
		...
		INSERT INTO [dbo].[tbl_ANT_RELATORIO_TEMP_PRODUCAO] ([MES], [RS], [SC], [MT], [MS], [PR], [SP], [DF], [MG], [ES], [RJ], [AM], [RR], [AP], [PA], [TO], [RO], [AC], [GO], [MA], [PI], [CE], [RN], [PB], [PE], [AL], [SE], [BA], [UF_OUTROS], [DIRE_A], [DIRE_B], [DIRE_C_D], [DIRE_E], [DIRE_F], [DIRE_G], [DIRE_H], [DIRE_OUTROS], [TOTAL])
		
		SELECT DISTINCT
			'MÊS' = DATEPART(MONTH, DATA_ATENDIMENTO)
